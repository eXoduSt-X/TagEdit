...
- Selección múltiple (tap / long-press) + "Todo" / "Ninguno", los 4 botones principales en una fila.
  El orden de selección (no la posición en la lista) es el que se usa para "Numeración
  automática": cada fila seleccionada muestra un numerito azul con su lugar en la cola.
  Para corregir el orden sin deseleccionar todo, tocá de nuevo un ítem ya seleccionado:
  sale de la cola y vuelve a entrar al final.
- Diálogo de edición masiva:
  ...
  - **Elegir portada / Aplicar a seleccionados**: elegís una imagen del dispositivo (picker
    del sistema, sin permisos extra) y se graba como carátula embebida en todos los
    seleccionados, reemplazando la que tuvieran.
